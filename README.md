# Elona+ Custom-GX 2.25

*\~Believe in Jure and hold a determination to mince.\~*

Elona+ Custom-GX is a new variant of Elona+ based on Elona+ Custom-G, updated with the changes in Elona+ up to version 2.25.
...
1. Download Elona+ 2.25 from [here](https://mega.nz/file/kbdwjRgZ#cc27dCTIonr52RZZIMNQ-LzduNWElPgCA8BB8QXGwsY). Extract it to `elonaplus2.25`.
2. Extract the contents of Custom-GX's archive to the `elonaplus2.25` folder, overwriting all existing files.
...
1. Follow the installation instructions above. Rename the `elonaplus2.25` folder to `2.05-custom-gx` and move it to the `assets/` folder of this repository.
